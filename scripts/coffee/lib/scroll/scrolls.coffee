define ['./singleAxis', '../utility/object'], (SingleAxisScroller, object) ->
	...
	class Scrolls
		...
		_scrollerAskedForAnimation: ->
			...
			unless @_animFrame
				@_animFrame = frames.onNextFrame @_boundAnimFunction
